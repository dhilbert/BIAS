...
function hd_temps_test0($temps){
	...
	$serviceKey = 'ZRsZF%2FzuUlEALtEeik3hz8Pa14i1Ow3j1SegtsGoqdAGbSbA7PYNa%2Bx3Xse1Iy2DemohfDRE2pwOb6OT0P%2Fiow%3D%3D';
	$url = "https://apis.data.go.kr/1611000/nsdi/eios/LdaregService/buldHoCoList.xml?serviceKey=".$serviceKey."&pnu=".$pnu."&numOfRows=".$numOfRows."&pageNo=".$pageNo."&buldDongNm=".$main_info['dongNm']."&buldHoNm=".$temp_hoNm;
