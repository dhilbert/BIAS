...
?>
			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					<div class="panel-heading">04.물건의 표시
					</div>
...
<?php
	...
	$temp_list = array(
		array('1','04.물건표시','표시 물건에 대한 정보 확인','text0'	),
	...
	for($total_num = 0 ; $total_num < count($temp_list) ; $total_num++){
		...
		$name = $temp_list[$total_num][$num] ;	hd_tbody_td($num,$name);$num+=1;
			...
			$name = "<a href='/BIAS/01_safeService/".$temp_list[$total_num][$num].".php'>확인하기</a>					" ;	hd_tbody_td($num,$name);
