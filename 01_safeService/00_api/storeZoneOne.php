...
<?php
	$want_array = array(
		array('key','상권번호','9174','조회 대상 상권의 상권번호'),
		
		array('type','타입','json','xml / json')
...
?>
			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					...
					<?php 
						$serviceKey = 'ZRsZF%2FzuUlEALtEeik3hz8Pa14i1Ow3j1SegtsGoqdAGbSbA7PYNa%2Bx3Xse1Iy2DemohfDRE2pwOb6OT0P%2Fiow%3D%3D';
						$url = "https://apis.data.go.kr/B553077/api/open/sdsc2/storeZoneOne?serviceKey=".$serviceKey."&key=".$key."&type=".$type;
						$response = file_get_contents($url);
						$arr = json_decode($response,true);
						
						$temp_name = array('trarNo','mainTrarNm','ctprvnCd','ctprvnNm','signguCd','signguNm','trarArea','coordNum','coords','stdrDt');
