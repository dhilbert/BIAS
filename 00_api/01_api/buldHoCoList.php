...
<?php
	...
	$buldDongNm = isset($_GET['buldDongNm']) ? $_GET['buldDongNm'] : 1;
	$buldHoNm = isset($_GET['buldHoNm']) ? $_GET['buldHoNm'] : 111;
	...
	$want_array = array(
		...
		array('buldDongNm','건축물의 동정보',$buldDongNm,'건축물의 동정보'),
		array('buldHoNm','건축물의 호정보',$buldHoNm,'건축물의 호정보'),
			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					...
					<?php 
						...
						$url = "https://apis.data.go.kr/1611000/nsdi/eios/LdaregService/buldHoCoList.xml?serviceKey=".$serviceKey."&pnu=".$pnu."&numOfRows=".$numOfRows."&pageNo=".$pageNo."&buldDongNm=".$buldDongNm."&buldHoNm=".$buldHoNm;
